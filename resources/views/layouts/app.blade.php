...
>
  <head>
    ...
    <style>
      ...
      html[data-color^="dark"] .card {
        background-color: var(--foreground);
        color: var(--body);
      }
      
      html[data-color^="dark"] .text-muted {
        color: var(--muted) !important;
      }
      
      html[data-color^="dark"] input.form-control,
      html[data-color^="dark"] select.form-control,
      html[data-color^="dark"] textarea.form-control {
        background-color: var(--background);
        border-color: var(--separator);
        color: var(--body);
      }
      
      html[data-color^="dark"] .btn-primary {
        background-color: var(--primary);
        border-color: var(--primary);
      }
      
      html[data-color^="dark"] a {
        color: var(--primary);
      }
      ...
      html[data-color^="dark"] .light-mode-icon {
        display: none;
      }
      
      html[data-color^="dark"] .dark-mode-icon {
        display: block;
      }
  ...
  <body>
    <div id="root">
      ...
      <div class="dark-mode-button-container position-fixed end-0 top-50 me-3">
        <button type="button" class="btn settings-button btn-primary p-0" id="colorButton">
          <span class="d-inline-block no-delay" data-bs-delay="0" data-bs-offset="0,3" data-bs-toggle="tooltip" data-bs-placement="left" title="Light/Dark Mode">
            <i data-acorn-icon="light-on" class="light-mode-icon"></i>
            <i data-acorn-icon="light-off" class="dark-mode-icon"></i>
          </span>
        </button>
      </div>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentColor = localStorage.getItem('acorn-standard-color');
        if (currentColor && currentColor.includes('dark')) {
        ...
        if (colorButton) {
          colorButton.addEventListener('click', function() {
            // Dispatch the light dark mode click event
            document.documentElement.dispatchEvent(new CustomEvent(Globals.lightDarkModeClick));
          });
        }
        ...
        if (settingsModal) {
          var bsSettingsModal = new bootstrap.Modal(settingsModal);
